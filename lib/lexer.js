...
(function (TokenType) {
    ...
    TokenType[TokenType["Abstract"] = 2] = "Abstract";
    TokenType[TokenType["Array"] = 3] = "Array";
    TokenType[TokenType["As"] = 4] = "As";
    TokenType[TokenType["Break"] = 5] = "Break";
    TokenType[TokenType["Callable"] = 6] = "Callable";
    TokenType[TokenType["Case"] = 7] = "Case";
    TokenType[TokenType["Catch"] = 8] = "Catch";
    TokenType[TokenType["Class"] = 9] = "Class";
    TokenType[TokenType["ClassConstant"] = 10] = "ClassConstant";
    TokenType[TokenType["Clone"] = 11] = "Clone";
    TokenType[TokenType["Const"] = 12] = "Const";
    TokenType[TokenType["Continue"] = 13] = "Continue";
    TokenType[TokenType["Declare"] = 14] = "Declare";
    TokenType[TokenType["Default"] = 15] = "Default";
    TokenType[TokenType["Do"] = 16] = "Do";
    TokenType[TokenType["Echo"] = 17] = "Echo";
    TokenType[TokenType["Else"] = 18] = "Else";
    TokenType[TokenType["ElseIf"] = 19] = "ElseIf";
    TokenType[TokenType["Empty"] = 20] = "Empty";
    TokenType[TokenType["EndDeclare"] = 21] = "EndDeclare";
    TokenType[TokenType["EndFor"] = 22] = "EndFor";
    TokenType[TokenType["EndForeach"] = 23] = "EndForeach";
    TokenType[TokenType["EndIf"] = 24] = "EndIf";
    TokenType[TokenType["EndSwitch"] = 25] = "EndSwitch";
    TokenType[TokenType["EndWhile"] = 26] = "EndWhile";
    TokenType[TokenType["EndHeredoc"] = 27] = "EndHeredoc";
    TokenType[TokenType["Eval"] = 28] = "Eval";
    TokenType[TokenType["Exit"] = 29] = "Exit";
    TokenType[TokenType["Extends"] = 30] = "Extends";
    TokenType[TokenType["Final"] = 31] = "Final";
    TokenType[TokenType["Finally"] = 32] = "Finally";
    TokenType[TokenType["For"] = 33] = "For";
    TokenType[TokenType["ForEach"] = 34] = "ForEach";
    TokenType[TokenType["Function"] = 35] = "Function";
    TokenType[TokenType["Global"] = 36] = "Global";
    TokenType[TokenType["Goto"] = 37] = "Goto";
    TokenType[TokenType["HaltCompiler"] = 38] = "HaltCompiler";
    TokenType[TokenType["If"] = 39] = "If";
    TokenType[TokenType["Implements"] = 40] = "Implements";
    TokenType[TokenType["Include"] = 41] = "Include";
    TokenType[TokenType["IncludeOnce"] = 42] = "IncludeOnce";
    TokenType[TokenType["InstanceOf"] = 43] = "InstanceOf";
    TokenType[TokenType["InsteadOf"] = 44] = "InsteadOf";
    TokenType[TokenType["Interface"] = 45] = "Interface";
    TokenType[TokenType["Isset"] = 46] = "Isset";
    TokenType[TokenType["List"] = 47] = "List";
    TokenType[TokenType["And"] = 48] = "And";
    TokenType[TokenType["Or"] = 49] = "Or";
    TokenType[TokenType["Xor"] = 50] = "Xor";
    TokenType[TokenType["Namespace"] = 51] = "Namespace";
    TokenType[TokenType["New"] = 52] = "New";
    TokenType[TokenType["Print"] = 53] = "Print";
    TokenType[TokenType["Private"] = 54] = "Private";
    TokenType[TokenType["Public"] = 55] = "Public";
    TokenType[TokenType["Protected"] = 56] = "Protected";
    TokenType[TokenType["Require"] = 57] = "Require";
    TokenType[TokenType["RequireOnce"] = 58] = "RequireOnce";
    TokenType[TokenType["Return"] = 59] = "Return";
    TokenType[TokenType["Static"] = 60] = "Static";
    TokenType[TokenType["Switch"] = 61] = "Switch";
    TokenType[TokenType["Throw"] = 62] = "Throw";
    TokenType[TokenType["Trait"] = 63] = "Trait";
    TokenType[TokenType["Try"] = 64] = "Try";
    TokenType[TokenType["Unset"] = 65] = "Unset";
    TokenType[TokenType["Use"] = 66] = "Use";
    TokenType[TokenType["Var"] = 67] = "Var";
    TokenType[TokenType["While"] = 68] = "While";
    TokenType[TokenType["Yield"] = 69] = "Yield";
    TokenType[TokenType["YieldFrom"] = 70] = "YieldFrom";
    TokenType[TokenType["DirectoryConstant"] = 71] = "DirectoryConstant";
    TokenType[TokenType["FileConstant"] = 72] = "FileConstant";
    TokenType[TokenType["LineConstant"] = 73] = "LineConstant";
    TokenType[TokenType["FunctionConstant"] = 74] = "FunctionConstant";
    TokenType[TokenType["MethodConstant"] = 75] = "MethodConstant";
    TokenType[TokenType["NamespaceConstant"] = 76] = "NamespaceConstant";
    TokenType[TokenType["TraitConstant"] = 77] = "TraitConstant";
    TokenType[TokenType["StringLiteral"] = 78] = "StringLiteral";
    TokenType[TokenType["FloatingLiteral"] = 79] = "FloatingLiteral";
    TokenType[TokenType["EncapsulatedAndWhitespace"] = 80] = "EncapsulatedAndWhitespace";
    TokenType[TokenType["Text"] = 81] = "Text";
    TokenType[TokenType["IntegerLiteral"] = 82] = "IntegerLiteral";
    TokenType[TokenType["Name"] = 83] = "Name";
    TokenType[TokenType["VariableName"] = 84] = "VariableName";
    TokenType[TokenType["Equals"] = 85] = "Equals";
    TokenType[TokenType["Tilde"] = 86] = "Tilde";
    TokenType[TokenType["Colon"] = 87] = "Colon";
    TokenType[TokenType["Semicolon"] = 88] = "Semicolon";
    TokenType[TokenType["Exclamation"] = 89] = "Exclamation";
    TokenType[TokenType["Dollar"] = 90] = "Dollar";
    TokenType[TokenType["ForwardSlash"] = 91] = "ForwardSlash";
    TokenType[TokenType["Percent"] = 92] = "Percent";
    TokenType[TokenType["Comma"] = 93] = "Comma";
    TokenType[TokenType["AtSymbol"] = 94] = "AtSymbol";
    TokenType[TokenType["Backtick"] = 95] = "Backtick";
    TokenType[TokenType["Question"] = 96] = "Question";
    TokenType[TokenType["DoubleQuote"] = 97] = "DoubleQuote";
    TokenType[TokenType["SingleQuote"] = 98] = "SingleQuote";
    TokenType[TokenType["LessThan"] = 99] = "LessThan";
    TokenType[TokenType["GreaterThan"] = 100] = "GreaterThan";
    TokenType[TokenType["Asterisk"] = 101] = "Asterisk";
    TokenType[TokenType["AmpersandAmpersand"] = 102] = "AmpersandAmpersand";
    TokenType[TokenType["Ampersand"] = 103] = "Ampersand";
    TokenType[TokenType["AmpersandEquals"] = 104] = "AmpersandEquals";
    TokenType[TokenType["CaretEquals"] = 105] = "CaretEquals";
    TokenType[TokenType["LessThanLessThan"] = 106] = "LessThanLessThan";
    TokenType[TokenType["LessThanLessThanEquals"] = 107] = "LessThanLessThanEquals";
    TokenType[TokenType["GreaterThanGreaterThan"] = 108] = "GreaterThanGreaterThan";
    TokenType[TokenType["GreaterThanGreaterThanEquals"] = 109] = "GreaterThanGreaterThanEquals";
    TokenType[TokenType["BarEquals"] = 110] = "BarEquals";
    TokenType[TokenType["Plus"] = 111] = "Plus";
    TokenType[TokenType["PlusEquals"] = 112] = "PlusEquals";
    TokenType[TokenType["AsteriskAsterisk"] = 113] = "AsteriskAsterisk";
    TokenType[TokenType["AsteriskAsteriskEquals"] = 114] = "AsteriskAsteriskEquals";
    TokenType[TokenType["Arrow"] = 115] = "Arrow";
    TokenType[TokenType["OpenBrace"] = 116] = "OpenBrace";
    TokenType[TokenType["OpenBracket"] = 117] = "OpenBracket";
    TokenType[TokenType["OpenParenthesis"] = 118] = "OpenParenthesis";
    TokenType[TokenType["CloseBrace"] = 119] = "CloseBrace";
    TokenType[TokenType["CloseBracket"] = 120] = "CloseBracket";
    TokenType[TokenType["CloseParenthesis"] = 121] = "CloseParenthesis";
    TokenType[TokenType["QuestionQuestion"] = 122] = "QuestionQuestion";
    TokenType[TokenType["Bar"] = 123] = "Bar";
    TokenType[TokenType["BarBar"] = 124] = "BarBar";
    TokenType[TokenType["Caret"] = 125] = "Caret";
    TokenType[TokenType["Dot"] = 126] = "Dot";
    TokenType[TokenType["DotEquals"] = 127] = "DotEquals";
    TokenType[TokenType["CurlyOpen"] = 128] = "CurlyOpen";
    TokenType[TokenType["MinusMinus"] = 129] = "MinusMinus";
    TokenType[TokenType["ForwardslashEquals"] = 130] = "ForwardslashEquals";
    TokenType[TokenType["DollarCurlyOpen"] = 131] = "DollarCurlyOpen";
    TokenType[TokenType["FatArrow"] = 132] = "FatArrow";
    TokenType[TokenType["ColonColon"] = 133] = "ColonColon";
    TokenType[TokenType["Ellipsis"] = 134] = "Ellipsis";
    TokenType[TokenType["PlusPlus"] = 135] = "PlusPlus";
    TokenType[TokenType["EqualsEquals"] = 136] = "EqualsEquals";
    TokenType[TokenType["GreaterThanEquals"] = 137] = "GreaterThanEquals";
    TokenType[TokenType["EqualsEqualsEquals"] = 138] = "EqualsEqualsEquals";
    TokenType[TokenType["ExclamationEquals"] = 139] = "ExclamationEquals";
    TokenType[TokenType["ExclamationEqualsEquals"] = 140] = "ExclamationEqualsEquals";
    TokenType[TokenType["LessThanEquals"] = 141] = "LessThanEquals";
    TokenType[TokenType["Spaceship"] = 142] = "Spaceship";
    TokenType[TokenType["Minus"] = 143] = "Minus";
    TokenType[TokenType["MinusEquals"] = 144] = "MinusEquals";
    TokenType[TokenType["PercentEquals"] = 145] = "PercentEquals";
    TokenType[TokenType["AsteriskEquals"] = 146] = "AsteriskEquals";
    TokenType[TokenType["Backslash"] = 147] = "Backslash";
    TokenType[TokenType["BooleanCast"] = 148] = "BooleanCast";
    TokenType[TokenType["UnsetCast"] = 149] = "UnsetCast";
    TokenType[TokenType["StringCast"] = 150] = "StringCast";
    TokenType[TokenType["ObjectCast"] = 151] = "ObjectCast";
    TokenType[TokenType["IntegerCast"] = 152] = "IntegerCast";
    TokenType[TokenType["FloatCast"] = 153] = "FloatCast";
    TokenType[TokenType["StartHeredoc"] = 154] = "StartHeredoc";
    TokenType[TokenType["ArrayCast"] = 155] = "ArrayCast";
    TokenType[TokenType["OpenTag"] = 156] = "OpenTag";
    TokenType[TokenType["OpenTagEcho"] = 157] = "OpenTagEcho";
    TokenType[TokenType["CloseTag"] = 158] = "CloseTag";
    TokenType[TokenType["Comment"] = 159] = "Comment";
    TokenType[TokenType["DocumentComment"] = 160] = "DocumentComment";
    TokenType[TokenType["Whitespace"] = 161] = "Whitespace";
...
(function (LexerMode) {
    ...
    LexerMode[LexerMode["Backtick"] = 7] = "Backtick";
